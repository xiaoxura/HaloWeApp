...
> 实施状态（2026-08-02）：V040-00～V040-07 已进入 RC；V040-08 的文档、自动化与包体已完成，
> 双 Halo/Moment runtime、双真机、真实微信、暗部署/恢复/回滚及依赖风险仍未通过，详见
> [release-checklist-v0.4.0.md](release-checklist-v0.4.0.md)。未满足 §12 前不得创建 v0.4.0/v0.2.0 tag。
> 编制日期：2026-08-01
> 小程序基线：HaloWeApp `v0.3.0`
> 配套插件基线：`plugin-halo-weapp` `v0.1.0`（`df1dcf3`）
...
| --- | --- | --- | ---: | --- | --- |
| V040-00 | v0.3.0 / 插件 v0.1.0 工作区、版本、文档与 tag 收口 | P0 | 1.0 人日 | 无 | 干净可回滚基线 |
...
- [ ] 双仓库开始开发前工作区干净，v0.3.0 / v0.1.0 有可回滚 tag；
- [ ] 三处小程序版本及插件版本一致；
...
10. v0.3.0 小程序 + 插件 v0.1.0 仍是可执行回滚路径。
...
- 五级：回滚 `plugin-halo-weapp` v0.1.0 与小程序 v0.3.0；恢复前一份 ConfigMap。
